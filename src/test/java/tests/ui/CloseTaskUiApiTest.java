...
@Test(groups = "ui")
public class CloseTaskUiApiTest extends BaseTest {
    ...
    public void closeTaskTest(){
        ...
        $(By.xpath("//*[@id=\"task-view\"]/div[1]/ul[2]/li[14]/a")).click();
        $(By.xpath("//*[@id=\"modal-confirm-button\"]")).click();
        $(By.xpath("//*[@id=\"task-summary\"]/div/div/div[1]/ul/li[1]/span")).shouldBe(Condition.text("closed"));
